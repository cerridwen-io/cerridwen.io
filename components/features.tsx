        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-gray-400">
              Increasingly unpredicatable weather patterns, rising costs of production, and a global pandemic have made
              it harder than ever for small farmers to make a living. We're here to help.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              <p className="text-lg text-gray-400 text-center">
                The food and agriculture sector generates more than $700 billion in wages, contributes $7 trillion to
                the nation's economy, and is responsible for 1/5 of the country's economic activity.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-lg text-gray-400 text-center">
                As of 2017, the U.S. has over two million farms, accounting for 900 million acres of land and 40% of the
            ...
            >
              ...
              <p className="text-lg text-gray-400 text-center">
                The U.S. has sustained 332 weather and climate disasters since 1980 where overall damages/costs reached
                or exceeded $1 billion (including CPI adjustment to 2020). The total cost of these 332 events exceeds
                $2.275 trillion.
              </p>
            </div>
